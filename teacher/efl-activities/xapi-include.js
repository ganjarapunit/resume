...
(function () {
  ...
  function startTracking() {
    ...
    var REAL_WRITING = [
      ...
      { file: 'annisa-day22', act: 'act13', fields: ['a13-draft'] },
      { file: 'annisa-day21', act: 'act13', fields: ['a13-draft'] },
      { file: 'annisa-day20', act: 'act13', fields: ['a13-draft'] },
      { file: 'annisa-day19', act: 'act13', fields: ['a13-draft'] },
      ...
      { file: 'shirley-b2-clauses', act: 'act15', fields: ['a151', 'a152', 'a153'], input: true },
      ...
      { file: 'annisa-day14', act: 'act9', fields: ['sp9'] },
      { file: 'annisa-day14', act: 'act10', fields: ['sp10'] },
      { file: 'annisa-day13', act: 'act6', fields: ['sp6'] },
      { file: 'annisa-day13', act: 'act7', fields: ['sp7'] },
      { file: 'annisa-day13', act: 'act8', fields: ['sp8'] },
      { file: 'annisa-day13', act: 'act9', fields: ['sp9'] },
      { file: 'annisa-day13', act: 'act10', fields: ['sp10'] },
      { file: 'annisa-day12', act: 'act7', fields: ['sp7'] },
      { file: 'annisa-day12', act: 'act8', fields: ['sp8'] },
      { file: 'annisa-day12', act: 'act9', fields: ['sp9'] },
      { file: 'annisa-day12', act: 'act10', fields: ['sp10'] },
      { file: 'annisa-day11', act: 'act1', fields: ['sp1'] },
      { file: 'annisa-day11', act: 'act9', fields: ['sp9'] },
      { file: 'annisa-day11', act: 'act10', fields: ['sp10'] },
      { file: 'annisa-day10', act: 'act8', fields: ['sp8'] },
      { file: 'annisa-day10', act: 'act9', fields: ['sp9'] },
      { file: 'annisa-day10', act: 'act10', fields: ['sp10'] },
      ...
      { file: 'lesson-19', act: 'act12', fields: ['a12sum', 'a12q'], input: true },
    ...
    function fileTag(){
      var f = location.pathname.toLowerCase();
      if (f.indexOf('lesson-19') > -1) return 'lesson-19';
      ...
      if (f.indexOf('annisa-day22') > -1) return 'annisa-day22';
      if (f.indexOf('annisa-day21') > -1) return 'annisa-day21';
      if (f.indexOf('annisa-day20') > -1) return 'annisa-day20';
      if (f.indexOf('annisa-day19') > -1) return 'annisa-day19';
      ...
      if (f.indexOf('annisa-day12') > -1) return 'annisa-day12';
      if (f.indexOf('annisa-day11') > -1) return 'annisa-day11';
      if (f.indexOf('annisa-day10') > -1) return 'annisa-day10';
